...
export function MarketplaceTopNav() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="bg-primary text-primary-foreground flex size-10 items-center justify-center rounded-[10px] text-base font-bold">
          <ShoppingCart className="size-5" />
        </span>
        <span className="text-[20px] font-semibold tracking-[-0.45px] text-[#0a0a0a]">
          United Pharma
        </span>
      </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          {showCart ?
            <Link
              ...
              className={cn(
                "relative text-[#364153] hover:text-[#0a0a0a]",
                cartActive && "text-primary"
              )}
            >
              <ShoppingCart className="size-[18px]" />
              {cartCount > 0 ?
                <span className="bg-primary text-primary-foreground absolute -right-2 -top-2 flex size-5 items-center justify-center rounded-full text-[12px]">
                  {cartCount}
                </span>
              : null}
            </Link>
