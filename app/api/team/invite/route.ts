...
<html><body style="font-family:system-ui,sans-serif;line-height:1.6;color:#18181b;">
  <p>You have been invited to join <strong>${safeOrg}</strong> on the Qevira Pharmaceutical Marketplace.</p>
  ...
  <p style="font-size:12px;color:#71717a;">Automated message from Qevira. Do not reply.</p>
</body></html>`;
    ...
    const { error: sendErr } = await resend.emails.send({
      ...
      to,
      subject: "You have been invited to join Qevira",
      html,
    });
