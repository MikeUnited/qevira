...
`avatar`, `badge`, `button`, `card`, `checkbox`, `dialog`, `dropdown-menu`, `input`, `input-otp`, `label`, `order-status-badge`, `pagination`, `popover`, `radio-group`, `select`, `separator`, `sheet`, `sidebar`, `skeleton`, `switch`, `table`, `tabs`, `textarea`, `tooltip`

### App-level `components/`

| Area | Components |
|------|------------|
| Shell / nav | `bamys-dashboard-shell.tsx`, `buyer-header.tsx`, `importer-header.tsx` |
